...
Country_G_4_dummy <- function(x){
  ...
  Country_bq16_4_dummy <- make_dummy(x$ASBS04A)
  Country_bq17_4_dummy <- make_dummy(x$ASBS04B)
  Country_bq18_4_dummy <- make_dummy(x$ASBS04C)
  Country_bq19_4_dummy <- make_dummy(x$ASBS04D)
  Country_bq20_4_dummy <- make_dummy(x$ASBS04E)
  Country_bq21_4_dummy <- make_dummy(x$ASBS04F)
  Country_bq22_4_dummy <- make_dummy(x$ASBS04G)
  Country_bq23_4_dummy <- make_dummy(x$ASBS04H)
  Country_bq24_4_dummy <- make_dummy(x$ASBS04I)
  Country_bq25_4_dummy <- make_dummy(x$ASBS05A)
  Country_bq26_4_dummy <- make_dummy(x$ASBS05B)
  Country_bq27_4_dummy <- make_dummy(x$ASBS05E)
  Country_bq28_4_dummy <- make_dummy(x$ASBS05F)
  Country_bq29_4_dummy <- make_dummy(x$ASBS05H)
  Country_bq30_4_dummy <- make_dummy(x$ASBS06A)
  Country_bq31_4_dummy <- make_dummy(x$ASBS06B)
  Country_bq32_4_dummy <- make_dummy(x$ASBS06C)
  Country_bq33_4_dummy <- make_dummy(x$ASBS06D)
  Country_bq34_4_dummy <- make_dummy(x$ASBS06E)
  Country_bq35_4_dummy <- make_dummy(x$ASBS06F)
  Country_bq36_4_dummy <- make_dummy(x$ASBS06G)

  
  Country_4_matM <- (as.double(as.vector(x$ASSSCI01))
                     +as.double(as.vector(x$ASSSCI02))
                     +as.double(as.vector(x$ASSSCI03))
                     +as.double(as.vector(x$ASSSCI04))
                     +as.double(as.vector(x$ASSSCI05)))/5000
  ...
  return(data.frame(cbind(Country_books_4_dummy,Country_gender_4_dummy,Country_language_4_dummy,Country_bq1_4_dummy,Country_bq2_4_dummy,Country_bq3_4_dummy,Country_bq4_4_dummy,Country_bq5_4_dummy,
                          ...
                          Country_bq30_4_dummy,Country_bq31_4_dummy,Country_bq32_4_dummy,Country_bq33_4_dummy,Country_bq34_4_dummy,Country_bq35_4_dummy,Country_bq36_4_dummy,
                          Country_grade_indicator,Country_4_matM)))
}
...
Country_G_8_dummy <- function(y){
  ...
  Country_bq16_8_dummy <- make_dummy(y$BSBS22A)
  Country_bq17_8_dummy <- make_dummy(y$BSBS22B)
  Country_bq18_8_dummy <- make_dummy(y$BSBS22C)
  Country_bq19_8_dummy <- make_dummy(y$BSBS22D)
  Country_bq20_8_dummy <- make_dummy(y$BSBS22E)
  Country_bq21_8_dummy <- make_dummy(y$BSBS22F)
  Country_bq22_8_dummy <- make_dummy(y$BSBS22G)
  Country_bq23_8_dummy <- make_dummy(y$BSBS22H)
  Country_bq24_8_dummy <- make_dummy(y$BSBS22I)
  Country_bq25_8_dummy <- make_dummy(y$BSBS23A)
  Country_bq26_8_dummy <- make_dummy(y$BSBS23B)
  Country_bq27_8_dummy <- make_dummy(y$BSBS23C)
  Country_bq28_8_dummy <- make_dummy(y$BSBS23D)
  Country_bq29_8_dummy <- make_dummy(y$BSBS23E)
  Country_bq30_8_dummy <- make_dummy(y$BSBS24A)
  Country_bq31_8_dummy <- make_dummy(y$BSBS24B)
  Country_bq32_8_dummy <- make_dummy(y$BSBS24C)
  Country_bq33_8_dummy <- make_dummy(y$BSBS24D)
  Country_bq34_8_dummy <- make_dummy(y$BSBS24F)
  Country_bq35_8_dummy <- make_dummy(y$BSBS24G)
  Country_bq36_8_dummy <- make_dummy(y$BSBS24H)
  
  
  Country_8_matM <- (as.double(as.vector(y$BSSSCI01))
                     +as.double(as.vector(y$BSSSCI02))
                     +as.double(as.vector(y$BSSSCI03))
                     +as.double(as.vector(y$BSSSCI04))
                     +as.double(as.vector(y$BSSSCI05)))/5000
  ...
  return(data.frame(cbind(Country_books_8_dummy,Country_gender_8_dummy,Country_language_8_dummy,Country_bq1_8_dummy,Country_bq2_8_dummy,Country_bq3_8_dummy,Country_bq4_8_dummy,Country_bq5_8_dummy,
                          ...
                          Country_bq30_8_dummy,Country_bq31_8_dummy,Country_bq32_8_dummy,Country_bq33_8_dummy,Country_bq34_8_dummy,Country_bq35_8_dummy,Country_bq36_8_dummy,
                          Country_grade_indicator,Country_8_matM)))
}
...
#dummy matrix for each country
{
  ...
  Country_7 <- Country_dummy(HongKong_4,HongKong_8)
  Country_8 <- Country_dummy(Iran_4,Iran_8)
  Country_9 <- Country_dummy(Ireland_4,Ireland_8)
  Country_10 <- Country_dummy(Italy_4,Italy_8)
  Country_11 <- Country_dummy(Japan_4,Japan_8)
  Country_12 <- Country_dummy(Korea_4,Korea_8)
  Country_13 <- Country_dummy(Kuwait_4,Kuwait_8)
  Country_14 <- Country_dummy(NewZealand_4,NewZealand_8)
  Country_15 <- Country_dummy(Oman_4,Oman_8)
  Country_16 <- Country_dummy(Ontario_4,Ontario_8)
  Country_17 <- Country_dummy(Quebec_4,Quebec_8)
  Country_18 <- Country_dummy(Singapore_4,Singapore_8)
  Country_19 <- Country_dummy(Taipei_4,Taipei_8)
  Country_20 <- Country_dummy(Turkey_4,Turkey_8)
  Country_21 <- Country_dummy(UAE_4,UAE_8)
  Country_22 <- Country_dummy(US_4,US_8)
}

ncol(Country_G_4_dummy(Georgia_4))
ncol(Country_G_8_dummy(Morocco_8))
#Country indicators
{
  Country_indicator_1 <- matrix(rep(c(rep(0,21),1),nrow(Country_1)),ncol=22,nrow=nrow(Country_1),byrow=T)
  Country_indicator_2 <- matrix(rep(c(rep(0,20),1,rep(0,1)),nrow(Country_2)),ncol=22,nrow=nrow(Country_2),byrow=T)
  Country_indicator_3 <- matrix(rep(c(rep(0,19),1,rep(0,2)),nrow(Country_3)),ncol=22,nrow=nrow(Country_3),byrow=T)
  Country_indicator_4 <- matrix(rep(c(rep(0,18),1,rep(0,3)),nrow(Country_4)),ncol=22,nrow=nrow(Country_4),byrow=T)
  Country_indicator_5 <- matrix(rep(c(rep(0,17),1,rep(0,4)),nrow(Country_5)),ncol=22,nrow=nrow(Country_5),byrow=T)
  Country_indicator_6 <- matrix(rep(c(rep(0,16),1,rep(0,5)),nrow(Country_6)),ncol=22,nrow=nrow(Country_6),byrow=T)
  Country_indicator_7 <- matrix(rep(c(rep(0,15),1,rep(0,6)),nrow(Country_7)),ncol=22,nrow=nrow(Country_7),byrow=T)
  Country_indicator_8 <- matrix(rep(c(rep(0,14),1,rep(0,7)),nrow(Country_8)),ncol=22,nrow=nrow(Country_8),byrow=T)
  Country_indicator_9 <- matrix(rep(c(rep(0,13),1,rep(0,8)),nrow(Country_9)),ncol=22,nrow=nrow(Country_9),byrow=T)
  Country_indicator_10 <- matrix(rep(c(rep(0,12),1,rep(0,9)),nrow(Country_10)),ncol=22,nrow=nrow(Country_10),byrow=T)
  Country_indicator_11 <- matrix(rep(c(rep(0,11),1,rep(0,10)),nrow(Country_11)),ncol=22,nrow=nrow(Country_11),byrow=T)
  Country_indicator_12 <- matrix(rep(c(rep(0,10),1,rep(0,11)),nrow(Country_12)),ncol=22,nrow=nrow(Country_12),byrow=T)
  Country_indicator_13 <- matrix(rep(c(rep(0,9),1,rep(0,12)),nrow(Country_13)),ncol=22,nrow=nrow(Country_13),byrow=T)
  Country_indicator_14 <- matrix(rep(c(rep(0,8),1,rep(0,13)),nrow(Country_14)),ncol=22,nrow=nrow(Country_14),byrow=T)
  Country_indicator_15 <- matrix(rep(c(rep(0,7),1,rep(0,14)),nrow(Country_15)),ncol=22,nrow=nrow(Country_15),byrow=T)
  Country_indicator_16 <- matrix(rep(c(rep(0,6),1,rep(0,15)),nrow(Country_16)),ncol=22,nrow=nrow(Country_16),byrow=T)
  Country_indicator_17 <- matrix(rep(c(rep(0,5),1,rep(0,16)),nrow(Country_17)),ncol=22,nrow=nrow(Country_17),byrow=T)
  Country_indicator_18 <- matrix(rep(c(rep(0,4),1,rep(0,17)),nrow(Country_18)),ncol=22,nrow=nrow(Country_18),byrow=T)
  Country_indicator_19 <- matrix(rep(c(rep(0,3),1,rep(0,18)),nrow(Country_19)),ncol=22,nrow=nrow(Country_19),byrow=T)
  Country_indicator_20 <- matrix(rep(c(rep(0,2),1,rep(0,19)),nrow(Country_20)),ncol=22,nrow=nrow(Country_20),byrow=T)
  Country_indicator_21 <- matrix(rep(c(rep(0,1),1,rep(0,20)),nrow(Country_21)),ncol=22,nrow=nrow(Country_21),byrow=T)
  Country_indicator_22 <- matrix(rep(c(1,rep(0,21)),nrow(Country_22)),ncol=22,nrow=nrow(Country_22),byrow=T)
}
...
Country_indicators <- rbind(Country_indicator_1,Country_indicator_2,Country_indicator_3,Country_indicator_4,
                            ...
                            Country_indicator_21,Country_indicator_22)
Country_variables <- rbind(Country_1,Country_2,Country_3,Country_4,Country_5,Country_6,Country_7,Country_8,
                           ...
                           Country_17,Country_18,Country_19,Country_20,Country_21,Country_22)
...
names(Dataset) <- c("i1","i2","i3","i4","i5","i6","i7","i8","i9","i10","i11","i12","i13","i14","i15","i16","i17","i18","i19","i20",
                    ...
                    "i201","i202","i203","i204","i205","i206","i207","i208","i209")
...
train_labels <- dplyr::select(train_dataset,c(i209))
test_data <- test_dataset %>% dplyr::select(i1,i2,i3,i4,i5,i6,i7,i8,i9,i10,i11,i12,i13,i14,i15,i16,i17,i18,
                                            ...
                                            i184,i185,i186,i187,i188,i189,i190,i191,i192,i193,i194,i195,
                                            i196,i197,i198,i199,i200,i201,i202,i203,i204,i205,i206,i207,i208)
test_labels <- dplyr::select(test_dataset,c(i209))
...
ASBS04A <- function(x,y){ 
  A=make_dummy(x$ASBM03I) 
  B=make_dummy(y$BSBM19I)
...
######################################################################################################
## Calculate the correlation of G4 prediction and actual value
Test <- Dataset[,1:225]
names(Test) <-  c("i1","i2","i3","i4","i5","i6","i7","i8","i9","i10","i11","i12","i13","i14","i15","i16","i17","i18","i19","i20",
                  "i21","i22","i23","i24","i25","i26","i27","i28","i29","i30",
                  "i31","i32","i33","i34","i35","i36","i37","i38","i39","i40",
...
M1 <- matrix(0,ncol=1,nrow=29)
M1[1,1] <- cor(test_predictions[1:S[1]],Dataset[,226][1:S[1]])
for (i in 2:29){
  M1[i,1] <- cor(test_predictions[(S[2*i-2]+1):S[2*i-1]],Dataset[,226][(S[2*i-2]+1):S[2*i-1]])
}
mean(M1)               
G4_predict <- test_predictions[1:S[1]]
for (i in 2:29){
  G4_predict <- c(G4_predict,test_predictions[(S[2*i-2]+1):S[2*i-1]])
}
G4_actual <- Dataset[,226][1:S[1]]
for (i in 2:29){
  G4_actual <- c(G4_actual,Dataset[,226][(S[2*i-2]+1):S[2*i-1]])
}
cor(G4_predict,G4_actual)
